<template>
    <div>
        ...
        <div>
            <div class="two-info-questions-1 question-section" v-bind:class="{'hidden' : oneInfoQuestionsOneHidden}">
                ...
                <button @click="showNextQuestion('oneInfoQuestionsOneHidden', 'oneInfoQuestionsTwoHidden')" class="next-question">&#8594;</button>
            </div>
            <div class="two-info-questions-2 question-section" v-bind:class="{'hidden' : oneInfoQuestionsTwoHidden}">
                <div class="question-wrapper">
                    <label for="msOneFirstName" class="question-label">First Sister Assigned's First Name (The one with completed survey)</label>
                    <input v-model="msOneFirstName" id="msOneFirstName" class="question-input"/>
                </div>
                <div class="question-wrapper">
                    <label for="msOneLastName" class="question-label">First Sister Assigned's Last Name</label>
                    <input v-model="msOneLastName" id="msOneLastName" class="question-input"/>
                </div>
                <button @click="showNextQuestion('oneInfoQuestionsTwoHidden', 'oneInfoQuestionsThreeHidden')" class="next-question">&#8594;</button>
            </div>
            <div class="two-info-questions-3 question-section" v-bind:class="{'hidden' : oneInfoQuestionsThreeHidden}">
                <div class="question-wrapper">
                ...
                <button @click="showNextQuestion('oneInfoQuestionsThreeHidden', 'oneInfoQuestionsFourHidden')" class="next-question">&#8594;</button>
            </div>
            <div class="two-info-questions-4 question-section" v-bind:class="{'hidden' : oneInfoQuestionsFourHidden}">
                <div class="question-wrapper">
                ...
                <button @click="showNextQuestion('oneInfoQuestionsFourHidden', 'oneInfoQuestionsFiveHidden')" class="next-question">&#8594;</button>
            </div>
            <div class="two-info-questions-5 question-section" v-bind:class="{'hidden' : oneInfoQuestionsFiveHidden}">
                <div class="question-wrapper">
                ...
                <button @click="finishQuestions('oneInfoQuestionsFiveHidden')" class="next-question">&#8594;</button>
            </div>
        ...
        <div v-bind:class="{'hidden' : completedTextHidden}">
            ...
            <p class="text-to-review">Sister {{msTwoLastName}} did not complete a survey yet, but I’m sure you will learn more about her as you reach out.</p>
            ...
            <div>
<textarea id="text-one-info" class="text-to-copy">
...
Sister {{msTwoLastName}} did not complete a survey yet, but I’m sure you will learn more about her as you reach out.
    ...
    export default {
        ...
        data() {
            return {
                ...
                msTwoNumber : '',
                text : '',
                oneInfoQuestionsOneHidden : false,
                oneInfoQuestionsTwoHidden : true,
                oneInfoQuestionsThreeHidden : true,
                oneInfoQuestionsFourHidden : true,
                oneInfoQuestionsFiveHidden : true,
        ...
        methods : {
            copyText() {
                let textToCopy = document.getElementById('text-one-info');
            ...
            reset() {
                ...
                this.msTwoNumber = '';
                this.text = '';
                this.oneInfoQuestionsOneHidden = false;
                this.oneInfoQuestionsTwoHidden = true;
                this.oneInfoQuestionsThreeHidden = true;
                this.oneInfoQuestionsFourHidden = true;
                this.oneInfoQuestionsFiveHidden = true;
